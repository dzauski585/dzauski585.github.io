...
=== "Pre-Case"
    ...
    - [Pre-Induction & Lines](cvor/cv_or_guide.md#pre-inductioninductionlines)
    - [Nerve Blocks](cvor/cv_or_guide.md#cardiac-aneshesia-nerve-blocks)
    - [TEE Basics](cvor/TEE.md)

=== "On Bypass"
    - [Pre-CPB Management](cvor/cv_or_guide.md#pre-cpb-time)
    - [On CPB](cvor/cv_or_guide.md#on-cpb)
    - [TEG & Coagulation](cvor/TEG.md)
...
=== "Emergency"
    - [Cardiac Arrest in OR](complications/cardiac_arrest_OR.md)
