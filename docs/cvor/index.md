...
predictable once you know the steps.

Before you walk in, make sure you have reviewed and understood [CVOR Case Guide](cv_or_guide.md)
...
- [TEE](TEE.md#exam-overview) — standard views before you need to find them and advanced measurements
...
|---------|---------------|
| [CVOR Case Guide](cv_or_guide.md) | Setup → induction → bypass → separation → transport |
| [Structural Heart & EP](structural_heart.md) | TAVR, mitral clips, lead extractions, PFA, Watchman |
| [Intraoperative TEE](TEE.md) | All standard views, probe technique, advanced measurements |
