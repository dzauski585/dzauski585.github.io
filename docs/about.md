...
| Source | Used For |
|--------|----------|
| [Hensley's Practical Approach to Cardiothoracic Anesthesia](https://www.amazon.com/...) | Primary textbook reference |
| [ICU One Pager](https://onepagericu.com) | TEG algorithm |
| [Life in the Fast Lane](https://litfl.com) | EKG interpretation content |
| [Stanford Emergency Manual](https://emergencymanual.stanford.edu) | Emergency checklists |
...
This site is an educational reference for anesthesia trainees.
It does not constitute medical advice. Clinical decisions should
be made in consultation with attending physicians and based on
